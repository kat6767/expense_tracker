...
// Función de obtención de datos de la db
  ...
  child: Text("Borrar datos de la bd (PRUEBAS)"),),*/
            Container(//primer contendor con aproxx 30% de la altura de la pantalla
            height: screenHeight*0.308,
            
            
            child: Column(//Columna para dividir el primer contendor en 2
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    Container(//Texto de bienvenida
                      height: 0.10*screenHeight,
                      color: Color.fromRGBO(232, 237, 234,1),
                      alignment: Alignment.centerLeft,
                      child: Padding(padding: const EdgeInsets.fromLTRB(35, 50, 0, 0),
                      child: Text('Bienvenido', style: TextStyle(color: Color.fromRGBO(5, 34, 36, 1), 
          ...
          fontSize: 18.0,),),),
                      ...
                      Container(//segundo contenedor aislado
                      height: 0.208*screenHeight,
                        ...
                        child: Row(
                         ...
                         height: 0.16*screenHeight,
                          ...
                          child: Row(//fila para logo y Gastos Totales
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              Container(//contendor para el logo
                                width: 0.25*screenWidht,
                                child: const Center(
                      child: Icon(Icons.show_chart, color: Colors.greenAccent, size: 60),
                    ),
                              ),
                              VerticalDivider(
                              ...
                              Container(
                                ...
                                child: Column(//colimna para 
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      const Text('Gastos Totales', style: TextStyle(color: Color.fromRGBO(242, 247,248,1), fontSize:12), ),
                                      const Text(r'-$1,1500.00', style: TextStyle(color: Color.fromRGBO(242, 247,248,1), fontWeight: FontWeight.bold),)//esta sera una variable lol creo
                                    ],
                                )
                              )
                            ],
          ...
          Container(// segundo contenedor con aprox el 70% de la altura de la pantalla
            height: screenHeight*0.692,
           decoration: BoxDecoration(
            color: Color.fromRGBO(241, 255, 243,1),
            borderRadius: BorderRadius.circular(40)
           ),
            child: Column(// para dividir segunda columna en 3
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Container(//contendor de Fecha y Monto
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(//contendor junior para padding manual
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Column(//colimna para 
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      const Text('Monto', style: TextStyle(
                      ...
                      Container(// para la lista de gastos e ingresos
                    ...
                    return ListTile(
                      ...
                      leading: Container(//para el icono
                                decoration: BoxDecoration(
                              color: Color.fromRGBO(2,48,36,1),
                              borderRadius: BorderRadius.circular(15)
                            ),
                                  width: 0.07*screenHeight,
                                  child: Icon(Icons.show_chart, color: Colors.greenAccent, size: 0.07*screenHeight)
                                ),
                      
                      
                      

                      title: Text(gasto.categoria, style: TextStyle(fontWeight: FontWeight.bold, 
                                          fontSize: 14),),


                        //\nDescripción: ${gasto.descripcion}   Codigo para acceder a descripcion
                      subtitle: Padding(
    padding: EdgeInsets.only(top: 5), // espaciado entre título y subtítulo
    child: Text('${gasto.fecha}')),
                        
                        trailing: Text("-\$${gasto.monto.toStringAsFixed(2)}", style: TextStyle(fontWeight: FontWeight.bold, 
                                          fontSize: 14),),
                        );
                      },
                   )
                      ),
                      Container(//para barra de opciones o boton de agregar
                      height: 0.092*screenHeight,
                      width: screenWidht,
                      child: Column(//el boton
                      mainAxisAlignment: MainAxisAlignment.center,
                      crossAxisAlignment: CrossAxisAlignment.end,
